...
namespace Test_Example.Activityes
{
    public class HeartRateAndroidBLE : IHeartRate
    {
        ...
        private Guid SERVICE_SPEED = Guid.ParseExact("00001816-0000-1000-8000-00805f9b34fb", "d");
        ...
        private Guid CHARACTERISTICS_SPEED = Guid.ParseExact("00002a5b-0000-1000-8000-00805f9b34fb", "d");
            ...
            if (_status == Status.STATUS_SCANNING_FOR_DEVICE)
            {
                ...
                if (e.Device.Name == _deviceName)
                {
                    try
                    {
                        ...
                        _serviceHR = await e.Device.GetServiceAsync(SERVICE_BATTERY);
                        _characteristicHR = await _serviceHR?.GetCharacteristicAsync(CHARACTERISTICS_SPEED);
